...
class HWGradesTable extends React.Component {
    ...
    handleRemoveButtonClick = async (state) => {
        return this.props.history.push({
            pathname: '/RemoveStudentHWGrades',
            id: state.id
        })
    };
...
export default withRouter(HWGradesTable);
